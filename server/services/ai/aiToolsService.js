...
export const getTopSellingPostersDeclaration = { name: 'getTopSellingPosters', description: 'Obtiene el ranking (Top 3 o Top 5) de los pósters más vendidos en el evento con fotos, unidades vendidas y recaudación.', parameters: { type: Type.OBJECT, properties: { eventId: { type: Type.STRING }, limit: { type: Type.INTEGER } } } };
